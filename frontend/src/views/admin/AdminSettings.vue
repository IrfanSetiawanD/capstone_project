  ...
  <div class="settings-page">
    ...
    <div class="card">
      <div class="card-header">
        ...
        <div>
          ...
          <p class="card-desc">Nomor tujuan pengiriman bukti pembelian dari customer</p>
        </div>
      </div>
      ...
      <div class="field-group">
        <div class="field">
          ...
          <div class="input-wrapper">
            ...
            />
            <span v-if="savedOnce && !errors.whatsapp && form.admin_whatsapp" class="input-badge">
          ...
          <p v-else class="field-hint">
            Format internasional tanpa "+", contoh: <span class="hint-code">6281234567890</span>
          </p>
        </div>
    ...
    <div class="card">
      ...
      <div class="field-group">
        <div class="override-grid">
          <button @click="setOverride(null)" :class="['override-btn', form.is_open_override === null ? 'override-btn--active-auto' : '']">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><rect x="3" y="4" width="18" height="18" rx="2"/><line x1="16" y1="2" x2="16" y2="6"/><line x1="8" y1="2" x2="8" y2="6"/><line x1="3" y1="10" x2="21" y2="10"/></svg>
            Ikut Jadwal
          </button>
          <button @click="setOverride(true)" :class="['override-btn', form.is_open_override === true ? 'override-btn--active-open' : '']">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M3 9l9-7 9 7v11a2 2 0 01-2 2H5a2 2 0 01-2-2z"/></svg>
            Paksa Buka
          </button>
          <button @click="setOverride(false)" :class="['override-btn', form.is_open_override === false ? 'override-btn--active-closed' : '']">
        ...
        <div class="field">
          <label class="label">Pesan saat toko tutup</label>
          <textarea v-model="form.closed_message" class="textarea" rows="2" placeholder="Maaf, kami sedang tidak beroperasi..."></textarea>
      ...
      <div v-if="form.is_open_override !== null" class="info-box info-box--warning">
        ...
        <p>Override manual aktif — toko dipaksa <strong>{{ form.is_open_override ? "BUKA" : "TUTUP" }}</strong>. Klik "Ikut Jadwal" untuk menonaktifkan.</p>
      </div>
    </div>
    ...
    <div class="card">
      ...
      <div class="hours-list">
        <div v-for="(day, idx) in DAY_OPTIONS" :key="idx" class="hours-row">
          <div class="hours-day">
    ...
    <div class="actions">
      ...
      <button v-if="hasChanges" @click="resetForm" class="btn-cancel">Batalkan</button>
    </div>
...
const setOverride = (val) => { form.value.is_open_override = val }
...
const fetchData = async () => {
  try {
    ...
    if (data) {
      ...
      savedOnce.value = !!data.admin_whatsapp
    }
  } catch (err) {
    console.error(err)
...
const validate = () => {
  let ok = true
  if (form.value.admin_whatsapp && !/^[0-9]{10,15}$/.test(form.value.admin_whatsapp)) {
...
const saveAll = async () => {
  ...
  try {
    ...
    try {
      ...
      if (payload.admin_whatsapp) localStorage.setItem("admin_whatsapp", payload.admin_whatsapp)
    }
...
.hours-row { display: flex; align-items: center; gap: 12px; padding: 11px 0; border-bottom: 1px solid rgba(255,255,255,0.04); }
