        ...
        <div class="relative z-10 max-w-7xl w-full mx-auto px-6 sm:px-10 pb-20 grid grid-cols-1 lg:grid-cols-12 gap-8 items-end">
          <div class="lg:col-span-7 space-y-6">
            ...
            <div class="flex items-center gap-3">
              ...
              <span class="font-mono text-[10px] tracking-[0.3em] text-[#DC2626] uppercase">Bekasi · Since 2021</span>
            </div>
...
const fetchCMSData = async () => {
  try {
    ...
    cms.value = {
      ...
      marquee_text:     d.marquee_text?.trim()     || "MASA SIH MURAH? • WARKOP EVOLUTION • GOOD FOOD • GOOD VIBES • SINCE 2021",
      about_text:       d.about_text?.trim()       || "Masashimura adalah usaha kuliner asal Bekasi yang berdiri sejak 2021. Mengusung konsep tempat makan kasual yang nyaman, kami hadir buat lo yang mau nongkrong sambil menikmati makanan dengan harga bersahabat.",
      about_image:      d.about_image || null,
      metric_1: d.metric_1?.trim() || "2021",
